<?php
require 'C:\xampp\htdocs\Xamsneaker\mail\PHPMailer\src\Exception.php';
require 'C:\xampp\htdocs\Xamsneaker\mail\PHPMailer\src\PHPMailer.php';
require 'C:\xampp\htdocs\Xamsneaker\mail\PHPMailer\src\SMTP.php';
...
try {
    ...
    //Recipients
    $mail->setFrom('phamthanhnhut11122002@gmail.com', 'Xamsneaker');
      //Add a recipient
      $mail->addAddress($bill['bill_email'], $bill['bill_name']);
      //Name is optional
    // $mail->addReplyTo('info@example.com', 'Information');
    $mail->addCC('phamthanhnhut11122002@gmail.com','Xamsneaker');
    $mail->addBCC('phamthanhnhut11122002@gmail.com','Xamsneaker');
